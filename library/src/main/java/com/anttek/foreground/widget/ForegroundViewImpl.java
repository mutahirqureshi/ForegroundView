 ...
 public class ForegroundViewImpl {
    ...
    public  void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        mForegroundGravity = a.getInt(
                R.styleable.ForegroundWidget_android_foregroundGravity, mForegroundGravity);

        final Drawable d = a.getDrawable(R.styleable.ForegroundWidget_android_foreground);
        if (d != null) {
            setForeground(d);
        }
